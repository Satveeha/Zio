...
public class UploadScreenThree extends AppLayout {
	...
	public void setChannelConfiguration(String alias) {
		...
		variableValueGrid.setItems(channelConfigDao.findChannelByPipelineAndChannel(pipelineName, channelName.getValue()));
	}
	...
	public void setFinalButtons() {
		...
		back.addClickListener(e -> {
			setContent(new UploadScreenTwo(this.pipelineConfigDao, this.channelConfigDao, this.commonConfigDao, pipelineName, filePath));
		});
