...
public class PipelineView extends Div implements AfterNavigationObserver {
    ...
    private void openDialog(String process) {
    	...
    	editPipelineConfig.setHeightFull();
    	editPipelineConfig.addColumn(EditPipelineConfig::getDescription).setHeader("Description");
    	editPipelineConfig.addColumn(EditPipelineConfig::getVariable).setHeader("Variable");
    	editPipelineConfig.addColumn(EditPipelineConfig::getValue).setHeader("Value");
